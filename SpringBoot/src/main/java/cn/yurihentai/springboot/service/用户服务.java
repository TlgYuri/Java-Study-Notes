package cn.yurihentai.springboot.service;
...
import cn.yurihentai.springboot.mapper.权限Mapper;
import cn.yurihentai.springboot.bean.用户;
import cn.yurihentai.springboot.bean.用户Example;
import cn.yurihentai.springboot.bean.角色;
import cn.yurihentai.springboot.mapper.用户Mapper;
import cn.yurihentai.springboot.mapper.角色Mapper;
...
public class 用户服务 {
    ...
    private final 权限Mapper 权限Mapper;

    @SuppressWarnings("SpringJavaInjectionPointsAutowiringInspection")
    @Autowired
    public 用户服务(用户Mapper 用户Mapper,
                角色Mapper 角色Mapper,
                cn.yurihentai.springboot.mapper.权限Mapper 权限Mapper) {
