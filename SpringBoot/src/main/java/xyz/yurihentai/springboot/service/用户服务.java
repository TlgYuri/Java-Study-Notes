package xyz.yurihentai.springboot.service;
...
import xyz.yurihentai.springboot.bean.权限;
import xyz.yurihentai.springboot.mapper.权限Mapper;
import xyz.yurihentai.springboot.bean.用户;
import xyz.yurihentai.springboot.bean.用户Example;
import xyz.yurihentai.springboot.bean.角色;
import xyz.yurihentai.springboot.mapper.用户Mapper;
import xyz.yurihentai.springboot.mapper.角色Mapper;
...
public class 用户服务 {
    ...
    public 用户服务(用户Mapper 用户Mapper,
                角色Mapper 角色Mapper,
                xyz.yurihentai.springboot.mapper.权限Mapper 权限Mapper) {
