package cn.yurihentai.cloud.consul;

import cn.yurihentai.cloud.consul.ribbonrule.MyRule;
 ...
 * name:指定该规则对哪个服务生效
 */
@ComponentScan(basePackages = "cn.yurihentai.cloud.consul", excludeFilters = {@ComponentScan.Filter(type= FilterType.REGEX, pattern = "cn.yurihentai.cloud.consul.ribbonrule.*")})
