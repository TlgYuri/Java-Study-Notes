package cn.yurihentai.java.net;
...
//        InetAddress 是 Java 对 IP 地址的封装。这个类的实例经常和 UDP DatagramSockets 和 Socket，ServerSocket 类一起使用。
        // 根据域名获取实例
        InetAddress address1 = InetAddress.getByName("yurihentai.cn");
        // 根据IP地址获取实例
...
//                byte[] buffer = new byte[65508];
    ...
    public static void testUrl() throws Exception {
        // 访问远程资源
        URL url = new URL("http://yurihentai.cn");
        ...
        // POST
        URL urlPost = new URL("http://yurihentai.cn");
