package cn.yurihentai.springaop;
...
public class MyLogger {
    ...
    @Pointcut("execution(* cn.yurihentai.springaop.*.*(..))")  //任意访问修饰符和返回值  org.yuri.springaop包下的所有包下的所有类的所有方法 (..)表示无关任意参数个数，匹配所有方法
    public void pointcut() {
    }

    @Before("execution(* cn.yurihentai.springaop.*.*(..))")
